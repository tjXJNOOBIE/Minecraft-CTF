 ...
 */
public final class CTFSetSpawn implements CommandExecutor, TabCompleter, MessageAccess {
    private final CtfMatchOrchestrator gameManager;
    private final TeamManager teamManager;

    public CTFSetSpawn(CtfMatchOrchestrator gameManager, TeamManager teamManager) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length != 1) {
            sender.sendMessage(msg("error.usage.ctf_setspawn"));
            return true;
        }
        ...
        gameManager.setTeamSpawn(player, teamKey);
        sender.sendMessage(msg("admin.setspawn.success", java.util.Map.of(
